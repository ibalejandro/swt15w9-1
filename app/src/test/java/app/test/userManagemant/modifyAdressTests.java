...
public class modifyAdressTests extends AbstractWebIntegrationTests{
	...
	public void modifyAddressWohnung() throws Exception{
		...
		mvc.perform(
				post("/modifyAddress_submit")
						.param("wohnen", "helper")
						.param("street", "Prager Str.")
						.param("housenr", "10")
						.param("postcode_H", "00000")
	...
	public void modifyAddressRefugee() throws Exception{
		...
		mvc.perform(
				...
				andExpect(status().isOk()).
				andExpect(view().name("modifyAddress")).
				andExpect(model().attributeExists("isRefugee")).
				andExpect(model().attributeExists("user"));
