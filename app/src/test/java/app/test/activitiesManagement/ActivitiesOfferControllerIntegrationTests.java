...
public class ActivitiesOfferControllerIntegrationTests extends AbstractWebIntegrationTests {
	 ...
	 * 
	 * @Test public void testUserOfferedActivities() { User user =
	 * userRepository.findByUserAccount
	 * (userAccountManager.findByUsername("Lisa").get()); int
	 * userOfferedActivities =
	 * ActivityEntity.getIterableSize(activitiesRepository.findByUser(user));
	 * System.out.println("Activities: " + userOfferedActivities);
	 * assertThat(userOfferedActivities, is(iterableSize +
	 * userOfferedActivitiesInTestDaten)); }
	 */
