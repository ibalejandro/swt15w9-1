...
AbstractWebIntegrationTests {
  ...
  public void testListUserOfferedGoods() throws Exception {
    ...
    .andExpect
    (model().attribute("resultGoods", is(iterableWithSize
                       (iterableSizeWithOnlyOneSave + user1Goods))));
  }
  ...
  public void testDeleteGood() throws Exception {
    ...
    (model().attribute("resultGoods", 
                       is(iterableWithSize(iterableSize - 1 + user1Goods))));
  }
