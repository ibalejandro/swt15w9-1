...
/**
 * <h1>ActivitiesRepository</h1> The ActivitiesRepository is a repository where
 * all offered activities are saved. When an activity isupdated or deleted, the
 * ActivitiesRepository is also modified.
 *
...
public interface ActivitiesRepository extends CrudRepository<ActivityEntity, Long> {
	 ...
	 * @param tag
	 *            The given tag
	 * @return Iterable<ActivityEntity> A list with all matches for the given
	 *         tag
	 */
	 ...
	 * 
	 * @param defaultTag
	 *            The given default tag for the activity
	 * @param currentTag
	 *            The activity's current tag
	 * @return Nothing
	 */
	@Modifying
