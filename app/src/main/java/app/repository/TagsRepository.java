...
/**
 * <h1>TagsRepository</h1> The TagsRepository is a repository where all
 * available tags are saved.
 *
...
public interface TagsRepository extends CrudRepository<TagEntity, Long> {
	 ...
	 *         different from the given tag's id in ascendant order
	 */
	 ...
	 * @param name
	 *            The given tag's name
	 * @return TagEntity A tag with matches with the given name ignoring the
	 *         case
	 */
