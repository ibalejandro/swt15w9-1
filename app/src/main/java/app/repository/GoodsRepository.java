...
/**
 * <h1>GoodsRepository</h1> The GoodsRepository is a repository where all
 * offered goods are saved. When a good is updated or deleted, the
 * GoodsRepository is also modified.
 *
...
public interface GoodsRepository extends CrudRepository<GoodEntity, Long> {
	 ...
	 * 
	 * @param defaultTag
	 *            The given default tag for the good
	 * @param currentTag
	 *            The good's current tag
	 * @return Nothing
	 */
	@Modifying
