...
/**
 * <h1>ActivitiesOfferController</h1> The ActivitiesOfferController is used to
 * offer and view offered activities by the users.
 *
...
public class ActivitiesOfferController {
	 ...
	 */
	@Autowired
	public ActivitiesOfferController(UserRepository userRepository, ActivitiesRepository activitiesRepository,
	...
	/**
	 * This method is the answer for the request to '/offerActivity'. It
	 * retrieves and and populates the tags dropdown with the whole available
	 * tags.
	 * 
	 * @param Model
	 *            The model to add response's attributes
	 * @param ActivityEntity
	 *            The activity to be filled and created
	 * @param Optional<UserAccount>
	 *            The user's account who wants to offer the activity
	...
	public String populateTagsDropdown(Model model, @ModelAttribute("activity") ActivityEntity activity,
	...
	public String saveActivity(HttpServletRequest request, Model model,
		...
		ActivityEntity activityToSave = new ActivityEntity(name, description, tag, picture, user, startDate, endDate);
