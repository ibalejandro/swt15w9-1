...
private final ActivitiesRepository activitiesRepository;
   ...
   * @param Optional<UserAccount> The admin's account who wants to see all the
   *                              available tags
   * @return String The name of the view to be shown after processing
   */
  ...
  (Model model, @LoggedIn Optional<UserAccount> userAccount) {
    /*
     * If there wasn't a log in instance for the admin, then he is redirected to 
     * an error page.
     */
   ...
   * @param Model The model to add response's attributes
   * @param TagEntity The tag to be refilled and updated
  ...
  public String showTagToUpdate(HttpServletRequest request, Model model,
    ...
    // If the tag is null, the admin is redirected to the available tags again.
    if (tagToUpdate == null) {
  ...
  /**
   * This method is the answer for the request to '/updatedTag'. It updates
   * a particular tag with the given information and retrieves the updated
   * tag.
   * @param HttpServletRequest The request with its information
   * @param Model The model to add response's attributes
   * @param TagEntity The tag to be updated
  ...
  public String updateTag(HttpServletRequest request, Model model, 
    ...
    /*
     * If there are errors in the parameters of the tag to be updated, the admin
     * is redirected to the tag-update form again.
     */
   ...
   * the tag that the admin wants to delete, set a default tag for all the goods
   * and activities related to the tag that he wants to remove and then deletes 
   * it.
   * @param HttpServletRequest The request with its information
   * @param Model The model to add response's attributes
   * @param Optional<UserAccount> The admin's account who wants to delete one of
   *                              the available tags
   * @return String The name of the view to be shown after processing
   */
   ...
   * offers.
   * @param Model The model to add response's attributes
   * @param TagEntity The tag to be filled and created
   * @param Optional<UserAccount> The admin's account who wants to add the new
   *                              tag
   * @return String The name of the view to be shown after processing
   */
  @RequestMapping(value = "/addNewTag", method = RequestMethod.GET)
  public String showFormToAddNewTag(Model model,
                                    @ModelAttribute("tag") TagEntity tag,
  ...
  /**
   * This method is the answer for the request to '/addedNewTag'. It saves
   * and retrieves the tag that the admin wants to add for the tags table.
   * @param HttpServletRequest The request with its information
   * @param Model The model to add response's attributes
   * @param Tagntity The tag to be created
   * @param BindingResult The parameter in charge of the validation result
   * @param Optional<UserAccount> The admin's account who wants to add the new 
   *                              tag
   * @return String The name of the view to be shown after processing
  ...
  public String addNewTag(HttpServletRequest request, Model model,
    ...
    /*
    * If there are errors in the parameters of the tag, the admin is redirected
    * to the tag form again.
    */
    if (bindingResult.hasErrors()) {
      System.out.println("Invalid tag: " + 
                         bindingResult.getAllErrors().toString());
  ...
  /**
   * This method is the answer for the request to '/offeredGoodsAndActivities'. 
   * It finds and retrieves all the offered goods and activities.
   * @param Model The model to add response's attributes
   * @param Optional<UserAccount> The admin's account who wants to see all
   *                              offered goods and activities
   * @return String The name of the view to be shown after processing
   */
  ...
  /**
   * This method is the answer for the request to '/updateGoodByAdmin'. It finds 
   * and retrieves the particular good that the admin wants to update.
   * @param HttpServletRequest The request with its information
   * @param Model The model to add response's attributes
  ...
  public String showGoodToUpdate(HttpServletRequest request, Model model,
     ...
     * the other tags are there, so that the admin can change the existing one.
     */
   ...
   * allows the admin to update a particular good with the given information and 
   * retrieves the updated good.
   * @param HttpServletRequest The request with its information
   * @param Model The model to add response's attributes
   ...
   * finds and retrieves the particular activity that the admin wants to update.
   * @param HttpServletRequest The request with its information
   * @param Model The model to add response's attributes
  ...
  public String showActivityToUpdate(HttpServletRequest request, Model model,
                                     @ModelAttribute("activity") ActivityEntity 
                                     activity, @LoggedIn Optional<UserAccount> 
                                     userAccount) {
    long id;
    ...
    /*
     * If the activity is null, the admin is redirected to all offered goods and
     * activities again.
     */
  ...
  /**
   * This method is the answer for the request to '/updatedActivityByAdmin'. It 
   * allows the admin to update a particular activity with the given information 
   * and retrieves the updated activity.
   * @param HttpServletRequest The request with its information
   * @param Model The model to add response's attributes
  ...
  public String updateActivity(HttpServletRequest request, Model model, 
                               @ModelAttribute("activity") ActivityEntity 
                               activity, BindingResult bindingResult,
                               RedirectAttributes redirectAttributes,
                               @LoggedIn Optional<UserAccount> userAccount) {
    long id = Long.parseLong(request.getParameter("id"));
    String name = request.getParameter("name");
     ...
     * admin is redirected to the activity-update form again.
     */
    if (bindingResult.hasErrors()) {
  ...
  /**
   * This method is the answer for the request to '/deletedActivityByAdmin'. It 
   * retrieves the activity that the admin wants to delete, removes it from the 
   * respective user and then deletes it from the activities table.
   * @param HttpServletRequest The request with its information
   * @param Model The model to add response's attributes
   * @param Optional<UserAccount> The admin's account who wants to delete one of
   *                              the offered activities
