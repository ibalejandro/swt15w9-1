...
/**
 * <h1>GoodsOfferController</h1> The GoodsOfferController is used to offer and
 * view offered goods/activities by the users.
 *
...
public class GoodsOfferController {
	 ...
	 */
	@Autowired
	public GoodsOfferController(UserRepository userRepository, GoodsRepository goodsRepository,
			ActivitiesRepository activitiesRepository, TagsRepository tagsRepository) {
	...
	/**
	 * This method is the answer for the request to '/home'. It finds and
	 * retrieves all the offered goods/activities by the users.
	 * 
	 * @param Model
	 ...
	 *            The model to add response's attributes
	 * @param GoodEntity
	 *            The good to be filled and created
	 * @param Optional<UserAccount>
	 *            The user's account who wants to offer the good
	 * @return String The name of the view to be shown after processing
	 */
	@RequestMapping(value = "/offer", method = RequestMethod.GET)
	public String populateTagsDropdown(Model model, @ModelAttribute("good") GoodEntity good,
	...
	/**
	 * This method is the answer for the request to '/offeredGood'. It saves and
	 * retrieves the good that the user wants to offer and associates it with
	 * him.
	 * 
	...
	public String saveGood(HttpServletRequest request, Model model, @ModelAttribute("good") GoodEntity good,
		...
		GoodEntity goodToSave = new GoodEntity(name, description, tag, picture, user);

		GoodValidator goodValidator = new GoodValidator();
		goodValidator.validate(goodToSave, bindingResult);
		/*
		 * If there are errors in the parameters of the good, the user is
		 * redirected to the good form again.
		 */
