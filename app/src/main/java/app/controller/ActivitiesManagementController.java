...
/**
 * <h1>ActivitiesManagementController</h1> The ActivitiesManagementController is
 * used to show, update and delete the offered activities by every particular
 * user.
 *
...
public class ActivitiesManagementController {
	 ...
	 */
	@Autowired
	public ActivitiesManagementController(UserRepository userRepository, ActivitiesRepository activitiesRepository,
	 ...
	 *            The user's account who wants to see his offered activities
	...
	public String listUserOfferedActivities(Model model, @LoggedIn Optional<UserAccount> userAccount) {
		/*
	 ...
	 * @param Optional<UserAccount>
	 *            The user's account who wants to update one of his offered
	 *            activities
	 * @return String The name of the view to be shown after processing
	 */
	...
	public String showActivityToUpdate(HttpServletRequest request, Model model,
			@ModelAttribute("activity") ActivityEntity activityEntity, @LoggedIn Optional<UserAccount> userAccount) {
		long id;
		...
		/*
		 * If the activitie's owner is different from the user trying to update
		 * the activity, the user is redirected to its offered activities again.
		 */
		 ...
		 * whereas the other tags are there, so that the user can change the
		 * existing one.
		 */
	...
	/**
	 * This method is the answer for the request to '/updatedActivity'. It
	 * updates a particular activity with the given information and retrieves
	...
	public String updateActivity(HttpServletRequest request, Model model,
			@ModelAttribute("activity") ActivityEntity activityEntity, BindingResult bindingResult,
		 ...
		 * the user is redirected to the activity-update form again.
		 */
		...
		/*
		 * If the activity's owner is different from the user trying to update
		 * the activity, the user is redirected to its offered activities again.
		 */
	 ...
	 *            The model to add response's attributes
	 * @param Optional<UserAccount>
	 *            The user's account who wants to delete one of his offered
	 *            activities
	 * @return String The name of the view to be shown after processing
	 */
	...
	public String deleteActivity(HttpServletRequest request, Model model, @LoggedIn Optional<UserAccount> userAccount) {
		...
		/*
		 * If the activity's owner is different from the user trying to delete
		 * the activity, the user is redirected to its offered activities again.
		 */
