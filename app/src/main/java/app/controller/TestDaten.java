...
public class TestDaten implements DataInitializer {
	...
	public TestDaten(UserAccountManager userAccountManager, UserRepository userRepository,
			...
			TextBlockRepository textBlockRepository, GoodsRepository goodsRepository,
	...
	private void initializeUsers(UserAccountManager userAccountManager, UserRepository userRepository,
		...
		Address address1 = new Address("Nöthnitzer Str.", "46", "01187", "Dresden");
		Address address2 = new Address("Prager Str.", "10", "01069", "Dresden");
		...
		/*
		 * Dialog d = new Dialog("My Dialog", user1, user2); Dialog savedDialog
		 * = dialogRepository.save(d); user1.addDialog(savedDialog);
	...
	private void initializeGoodsAndActivities(UserAccountManager userAccountManager, UserRepository userRepository,
		...
		GoodEntity testGood5 = new GoodEntity("Test5", "5th TestGood", tagsRepository.findByName("Jewelry & Watches"),
				null, user6);
	...
	/**
	 * Creates a List with all Test InterfaceParts for the following Languages:
	...
	public List<InterfacePart> createInterfacePart(ModuleRepository modRes, LanguageRepository lanRes) {
		...
		InterfacePart in1 = new InterfacePart("Der Nutzername oder das Passwort sind falsch!", lanDE.getId(),
				mod2.getId());
		...
		InterfacePart in21 = new InterfacePart(
				...
				lanDE.getId(), mod8.getId());
		InterfacePart in22 = new InterfacePart(
				"The activation mail has been sent to your mail address. Please click on the link in it to activate your account.",
				lanEN.getId(), mod8.getId());
		...
		InterfacePart in45 = new InterfacePart(" Sie haben gerade diese Kategorie hinzugefügt ", lanDE.getId(),
				mod20.getId());
		...
		InterfacePart in135 = new InterfacePart(
				"Wollen Sie ihr Nutzerkonto wirklich deaktivieren? Diese Aktion kann nur von einem Administrator r&uuml;ckg&auml;ngig gemacht werden. Deaktivierte Nutzerkonten werden nach 3 Monaten gel&ouml;scht.",
				lanDE.getId(), mod61.getId());
		InterfacePart in136 = new InterfacePart(
				"Do you really want to deactivate your user account? This action can only be undone by an admin. Deactivated accounts will be deleted after three months.",
				lanEN.getId(), mod61.getId());
		InterfacePart in137 = new InterfacePart(
				"In Ihrem Browser ist JavaScript deaktiviert. Für die Anzeige des Captcha wird Javascript ben&ouml;tigt.",
				lanDE.getId(), mod62.getId());
		InterfacePart in138 = new InterfacePart(
				"JavaScript is deactivated in your browser. It's required for displaying the Captcha.", lanEN.getId(),
				mod62.getId());
		...
		InterfacePart in143 = new InterfacePart("Sie haben soeben die folgende Aktivität gelöscht ", lanDE.getId(),
				mod65.getId());
		InterfacePart in144 = new InterfacePart("You just deleted this activity ", lanEN.getId(), mod65.getId());

		InterfacePart in145 = new InterfacePart("Sie haben soeben das folgende Gut gelöscht ", lanDE.getId(),
				mod66.getId());
		InterfacePart in146 = new InterfacePart("You just deleted this good ", lanEN.getId(), mod66.getId());

		InterfacePart in147 = new InterfacePart("Sie haben soeben die folgende Kategorie gelöscht ", lanDE.getId(),
				mod67.getId());
		...
		InterfacePart in165 = new InterfacePart("Es ist leider ein unbekannter Fehler aufgetreten.", lanDE.getId(),
				mod76.getId());
		...
		InterfacePart in169 = new InterfacePart(
				"Ihr Konto ist noch nicht aktiviert. Bitten klicken Sie auf den Aktivierungslink in der an Sie gesendeten E-Mail.",
				lanDE.getId(), mod78.getId());
		InterfacePart in170 = new InterfacePart(
				"Your account is not yet activated. Please click on the activation link in the mail we sent to you.",
				lanEN.getId(), mod78.getId());
		...
		InterfacePart in245 = new InterfacePart("Das Passwort ist zu kurz! Mindestens 8 Zeichen.", lanDE.getId(),
				mod116.getId());
		InterfacePart in246 = new InterfacePart("Your password is too short! It needs at least 8 characters.",
				lanEN.getId(), mod116.getId());
		...
		InterfacePart in271 = new InterfacePart("Sie haben soeben die folgende Aktivität angeboten", lanDE.getId(),
				mod129.getId());
		InterfacePart in272 = new InterfacePart("You just offered this good", lanEN.getId(), mod129.getId());
		InterfacePart in273 = new InterfacePart("Sie haben soeben das folgende Gut angeboten", lanDE.getId(),
				mod130.getId());
		...
		InterfacePart in303 = new InterfacePart("Sie haben soeben diese Aktivität geändert.", lanDE.getId(),
				mod145.getId());
		...
		InterfacePart in307 = new InterfacePart("Sie haben soeben diese Kategorie geändert.", lanDE.getId(),
				mod147.getId());
		...
		InterfacePart in317 = new InterfacePart(
				"Mindestens 8 Zeichen, min ein Kleinbuchstaben, min ein Gro&szlig;buchstaben, min eine Zahl und min ein Sonderzeichen.",
				lanDE.getId(), mod152.getId());
		InterfacePart in318 = new InterfacePart(
				"At least 8 characters, at least one lower case letter, at least one upper case letter, at least one number and at least one special character.",
				lanEN.getId(), mod152.getId());
