...
/**
 * <h1>GoodsManagementController</h1> The GoodsManagementController is used to
 * show, update and delete the offered goods by every particular user.
 *
...
public class GoodsManagementController {
	 ...
	 */
	@Autowired
	public GoodsManagementController(UserRepository userRepository, GoodsRepository goodsRepository,
	 ...
	 *            The user's account who wants to see his offered goods
	...
	public String showGoodToUpdate(HttpServletRequest request, Model model, @ModelAttribute("good") GoodEntity good,
		...
		// If the good is null, the user is redirected to its offered goods
		// again.
		...
		/*
		 * If the good's owner is different from the user trying to update the
		 * good, the user is redirected to its offered goods again.
		 */
	...
	/**
	 * This method is the answer for the request to '/updatedGood'. It updates a
	 * particular good with the given information and retrieves the updated
	 * good.
	 * 
	 * @param HttpServletRequest
	 *            The request with its information
	...
	public String updateGood(HttpServletRequest request, Model model, @ModelAttribute("good") GoodEntity good,
		 ...
		 * user is redirected to the good-update form again.
		 */
	...
	public String deleteGood(HttpServletRequest request, Model model, @LoggedIn Optional<UserAccount> userAccount) {
		...
		/*
		 * If the good's owner is different from the user trying to delete the
		 * good, the user is redirected to its offered goods again.
		 */
