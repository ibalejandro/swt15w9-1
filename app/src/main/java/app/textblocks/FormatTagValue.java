...
public abstract class FormatTagValue {
	...
	/**
	 * This constructor is for creating empty FormatTagValues to be used as
	 * initial values in new FormatTags.
	 *
	...
	/**
	 * This is the canonical function for constructing a {@link FormatTagValue}
	 * from the {@link String} out of a html form
	 * <p>
	 * It verifies the input and either throws a type error or constructs the
	 * value.
	 *
	 * @param tag
	 *            tag to associate the constructed value with
	 * @param value
	 ...
	 * <p>
	 * This should be overwritten in subclasses if the input needs a specific
	 * structure. See {@link DateFormatTagValue#verify(String)}
	 *
	 * @param value
